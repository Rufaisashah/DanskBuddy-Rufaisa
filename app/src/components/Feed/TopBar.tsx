...
export default function TopBar({ onSearch }: Props) {
  ...
  return (
    <header className="left-0 right-0 border-b border-transparent bg-white px-4 py-4 sm:px-6 md:border-[#ebe5dd] lg:px-8 z-50">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between">
        <h1 className="m-0 text-3xl font-bold leading-tight tracking-[-0.02em] text-[#161616]">
          Fællesskab
        </h1>
